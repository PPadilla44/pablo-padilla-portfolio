...
function App() {
  return (
    <div className="w-full h-screen bg-60-light">


      <section className="w-full h-full bg-hero bg-no-repeat bg-[length:130%] lg:bg-[length:140%] bg-hero-pos flex items-center justify-center flex-col">
